 ...
 * Uses agent.actions.swipe(startx, starty, endx, endy, duration)
 */
export async function scrollDown(): Promise<void> {
    // Swipe from bottom to top
    // Assuming 1080x2400 screen roughly
    await agent.actions.swipe(500, 1600, 500, 800, 300);
}
...
export function getAllNodes(node: AndroidNode): AndroidNode[] {
